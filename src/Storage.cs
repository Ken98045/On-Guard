...
namespace OnGuardCore
{
  ...
  class RegistryStorage : IStorage
  {
    ...
    public AreaNotificationOption GetNotificationOption(RegistryKey key)
    {
    ...
    public string GetCameraPrefix(RegistryKey reg)
    {
    ...
    public string GetCameraPath(RegistryKey key)
    {
    ...
    public CameraContactData GetContactData(RegistryKey key)
    {
      if (key != null)
      {
    ...
    public void SetCameraContactData(RegistryKey key, CameraContactData data)
    {
    ...
    public void SaveCamera(RegistryKey camKey, CameraData camera)
    {
