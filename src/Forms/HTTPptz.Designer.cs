...
namespace OnGuardCore
{
  partial class HTTPptz
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.label1.Text = "HTTP PTZ  Movement Commands";
      // 
      // label2
      // 
      ...
      this.label8.Location = new System.Drawing.Point(39, 334);
      ...
      this.Controls.Add(this.textBoxZoomOut);
      this.Controls.Add(this.textBoxZoomIn);
      ...
      this.Name = "HTTPptz";
      this.Text = "HTTP Pan Tilt & Zoom Movement Commands";
